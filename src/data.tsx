...
const findOrganisationEntity = (orgId: string): Entity => {
  ...
  return search(initialOrganisations) || { id: orgId, name: orgId }
}
...
const rawDevicesData: Record<string, Device[]> = {
  pmi: [], // Parent PMI has no direct devices
  'pmi-morrisons': [
    {
      id: 'morrisons-1',
      name: 'Rubery Screen 1',
      tags: ['Convenience', 'Full Gantry'],
      location: 'Birmingham',
    ...
    {
      id: 'morrisons-2',
      name: 'Rubery Screen 2',
      tags: ['4m LED Header', 'Main Store'],
      location: 'Birmingham',
      organisation: { id: 'pmi-morrisons', name: 'Morrisons' },
      model: '4m LED Header',
      status: 'offline',
    ...
    {
      id: 'morrisons-3',
      name: 'Rubery Screen 3',
      tags: ['43" Screen', 'Main Store', 'IQOS', 'Veev'],
      location: 'Birmingham',
      organisation: { id: 'pmi-morrisons', name: 'Morrisons' },
      model: '43in Screen',
      status: 'error',
    ...
    {
      id: 'morrisons-5',
      name: 'Stirchley Screen 2',
      tags: ['Convenience', 'Plug in Back Wall'],
      location: 'Birmingham',
      organisation: { id: 'pmi-morrisons', name: 'Morrisons' },
      model: '600 Header',
      status: 'online',
  ...
  'pmi-sainsburys': [
    ...
    {
      id: 'sainsburys-2',
      name: 'Northfield Screen 2',
      tags: ['Customer Services', 'IQOS', '4M'],
      location: 'Birmingham',
      organisation: { id: 'pmi-sainsburys', name: 'Sainsburys' },
      model: '4m LED Header',
      status: 'asleep',
    ...
    {
      id: 'sainsburys-4',
      name: 'Leeds Headrow Screen 2',
      tags: ['Customer Services', 'IQOS', '2M'],
      location: 'Leeds',
      organisation: { id: 'pmi-sainsburys', name: 'Sainsburys' },
      model: '2m LED Header',
      status: 'online',
    ...
    },
    {
      ...
      version: '1.0.0',
      position: { lat: 52.0406, lng: -0.7594 },
    ...
    {
      id: 'sainsburys-7',
      name: 'Milton Keynes Screen 3',
      tags: ['Counter Screen', 'Zyn', 'Customer Services'],
      location: 'Milton Keynes',
      organisation: { id: 'pmi-sainsburys', name: 'Sainsburys' },
      model: '32" Screen',
      status: 'online',
      ...
      resolution: getResolutionForModel('32" Screen'),
    },
    {
      id: 'sainsburys-8',
      name: 'Bishop Auckland Screen 1',
      tags: ['Customer Services'],
      ...
      version: '1.0.0',
      position: { lat: 54.6579, lng: -1.6756 },
      address: 'Bishop Auckland, UK',
