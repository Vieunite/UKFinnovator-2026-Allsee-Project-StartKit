...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Text styles
    'text-left text-base/6 text-zinc-950 dark:text-textDarkMode sm:text-sm/6 forced-colors:text-[CanvasText]',
    // Focus
    ...
    '[&>[data-slot=icon]]:text-zinc-500 [&>[data-slot=icon]]:data-[focus]:text-white [&>[data-slot=icon]]:dark:text-zinc-400 [&>[data-slot=icon]]:data-[focus]:dark:text-textDarkMode',
    // Avatar
