      ...
      >
        <Headless.ListboxSelectedOption
          ...
          className={clsx([
            ...
            // Typography
            'dark:text-textDarkMode text-left text-base/6 text-zinc-950 placeholder:text-zinc-500 sm:text-sm/6 forced-colors:text-[CanvasText]',
            // Border
        ...
        return (
          <div
            className={clsx(
              ...
              // Typography
              'dark:text-textDarkMode text-base/6 text-zinc-950 sm:text-sm/6 forced-colors:text-[CanvasText]',
              // Focus
