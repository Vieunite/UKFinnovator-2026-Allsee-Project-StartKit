...
const styles = {
  ...
  outline: [
    ...
    // Dark mode
    'dark:border-white/15 dark:text-textDarkMode dark:[--btn-bg:transparent] dark:data-[active]:bg-white/5 dark:data-[hover]:bg-white/5',
    // Icon
  ...
  plain: [
    ...
    // Dark mode
    'dark:text-textDarkMode dark:data-[active]:bg-white/10 dark:data-[hover]:bg-white/10',
    // Icon
  ...
  colors: {
    'dark/zinc': [
      ...
      'dark:text-textDarkMode dark:[--btn-bg:theme(colors.zinc.600)] dark:[--btn-hover-overlay:theme(colors.white/5%)]',
    ...
    light: [
      ...
      'dark:text-textDarkMode dark:[--btn-hover-overlay:theme(colors.white/5%)] dark:[--btn-bg:theme(colors.zinc.800)]',
      '[--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)] data-[hover]:[--btn-icon:theme(colors.zinc.700)] dark:[--btn-icon:theme(colors.zinc.500)] dark:data-[active]:[--btn-icon:theme(colors.zinc.400)] dark:data-[hover]:[--btn-icon:theme(colors.zinc.400)]',
    ],
    'dark/white': [
      'text-white [--btn-bg:theme(colors.zinc.900)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
